...
import hashlib
import sys
# Open the file with read only permit Step1
...
#LGRhashcode for filename Step2
fname = 'TEST_HASH.txt'
...
#HASH CODE for Filename with TR Step3
# Open the file with read only permit
f = open('c:\\code\\TEST_HASH_HASH.txt')
outF = open('c:\\code\\LGRhashfile.txt', "w")
# use readline() to read the first line
line = f.readline()

file_textSr = input(" Enter Sr.No: ")
file_textFname = input(" Enter From : ")
file_textFTo = input(" Enter TO : ")
File_TR = input(" Enter T Or R : ")

Str = file_textSr+' ' + file_textFname+ ' ' +file_textFTo+ ' ' +File_TR+ ' '+ line+' '+str(datetime.datetime.now())

outF.write(Str)
print("File Hashcode Generated Successfully")
